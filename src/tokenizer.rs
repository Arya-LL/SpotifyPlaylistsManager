// Taken from https://github.com/tracel-ai/burn/blob/main/examples/text-classification/src/data/tokenizer.rs
...
impl Default for BertCasedTokenizer {
    fn default() -> Self {
        Self {
            tokenizer: tokenizers::tokenizer::Tokenizer::from_pretrained("bert-base-cased", None)
                .unwrap(),
        }
    }
}
